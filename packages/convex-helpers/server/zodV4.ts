...
export function formatZodError(
  ...
  if (options?.format === "flat") {
    ...
    if (fieldErrors.length > 0) {
      const grouped = fieldErrors.reduce(
        (acc, issue) => {
...
export function zodToJsonSchema(
  ...
  try {
    ...
    console.warn(
      "Failed to generate JSON Schema with z.toJSONSchema, using fallback:",
      error,
    );
...
export function convexToZod<V extends GenericValidator>(
  ...
  switch (convexValidator.kind) {
    ...
    case "record": {
      ...
      if (
        valueValidator.kind === "union" &&
        Array.isArray(valueValidator.members)
      ) {
        // Check if this is a union of [SomeType, null]
        const hasNull = valueValidator.members.some(
          (m: any) => m.kind === "null",
        );
        const nonNullMembers = valueValidator.members.filter(
          (m: any) => m.kind !== "null",
        );
        ...
        if (hasNull && nonNullMembers.length === 1) {
          ...
          if (
            "_zodDefault" in valueValidator &&
            valueValidator._zodDefault !== undefined
          ) {
  ...
  if (
    ...
    "optional" in zodValidator &&
    typeof zodValidator.optional === "function"
  ) {
                    ...
                    : V extends VArray<any, infer E, any>
                      ...
                      : V extends VObject<any, infer F, any, any>
                        ...
                        : V extends VRecord<any, any, infer Val, any, any>
                          ? z.ZodRecord<
                              z.ZodString,
                              ZodTypeFromConvexValidator<Val>
                            >
...
function convertZodTupleToConvex(
  ...
  items.forEach((item, index) => {
    ...
    fields[`_${index}`] = useRecursiveCall
      ? zodToConvexInternal(item)
      : zodToConvex(item);
  });
  ...
  if (rest) {
    ...
    const objectValidator = v.object(fields);
    (objectValidator as any)._zodTupleRest = useRecursiveCall
      ? zodToConvexInternal(rest as z.ZodTypeAny)
      : zodToConvex(rest as z.ZodTypeAny);
    ...
    switch (defType) {
      ...
      case "pipe": {
        ...
        // Check for custom branded validators
          ...
          console.warn(
            "Encountered transform without explicit metadata. Consider using zTransform() for better type safety.",
          );
          convexValidator = v.any();
        }
        break;
                          ...
                          : Z extends z.ZodRecord<infer K, infer V>
                            ? K extends z.ZodString
                              ? VRecord<
                                  Record<
                                    string,
                                    ConvexValidatorFromZodRequired<
                                      V & z.ZodType
                                    >["type"]
                                  >,
                            ...
                            : Z extends z.ZodNullable<infer Inner>
                              ? Inner extends z.ZodOptional<infer InnerInner>
                                ? // Handle nullable(optional(T)) as optional(union(T, null))
                                  VOptional<
                                    VUnion<
                                      | ConvexValidatorFromZodBase<
                                          InnerInner & z.ZodType
                                        >["type"]
                                      | null,
                                      [
                                        ConvexValidatorFromZodBase<
                                        ...
                                        ...{
                                          [K in keyof T]: K extends "0" | "1"
                                            ...
                                            : K extends keyof T
                                              ? ConvexValidatorFromZodRequired<
                                                  T[K]
                                                > // ✅ Use helper to handle optional union members correctly
                                              : never;
                                        }[keyof T & number][],
                                      ],
                                        ...
                                        : K extends z.ZodUnion<any>
                                          ? V extends z.ZodOptional<any>
                                            ...
                                            : VRecord<
                                              ...
                                              >
                                          : never
                                      : Z extends z.ZodTemplateLiteral<
                                            infer Template
                                          >
                                        ...
                                        : Z extends z.ZodTuple<infer Items>
                                          ...
                                          : Z extends Zid<infer TableName>
                                            ...
                                            : Z extends z.ZodTransform<
                                                  infer Input extends z.ZodType,
                                                  any
                                                >
                                              ? ConvexValidatorFromZod<
                                                  Input,
                                                  Constraint
                                                > // Handle transforms by using input type
                                              : Z extends z.ZodPipe<
  ...
  generateTestData: (schema: z.ZodType): any => {
    ...
    if (schema instanceof z.ZodObject) {
      ...
      for (const [key, fieldSchema] of Object.entries(shape)) {
        obj[key] = convexZodTestUtils.generateTestData(
